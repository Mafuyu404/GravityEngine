...
public final class CollisionTolerances {
     ...
     */
    public static boolean sameConstraintIdentity(net.minecraft.world.phys.Vec3 first, net.minecraft.world.phys.Vec3 second) {
        return first.dot(second) >= SAME_CONSTRAINT_IDENTITY_DOT;
    }

    /** Neutral-vector identity test; see {@link #sameConstraintIdentity}. */
    public static boolean sameConstraintIdentity(Vector3dc first, Vector3dc second) {
        return first.dot(second) >= SAME_CONSTRAINT_IDENTITY_DOT;
    }
}
