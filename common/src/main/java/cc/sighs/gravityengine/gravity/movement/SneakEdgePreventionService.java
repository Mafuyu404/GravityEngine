...
public final class SneakEdgePreventionService {
     ...
     */
    public static Vec3d constrainTangentMovement(
            GravityFrame frame,
            CollisionBody body,
            Vec3d displacement,
            SupportProbe probe
        ...
        Vec3d local = frame.worldToLocal(displacement);
        ...
        return frame.localToWorld(new Vec3d(dx, vertical, dz));
    }
    ...
    private static boolean fallsAt(
        ...
        Vec3d tangent = frame.localToWorld(
                new Vec3d(tangentX, 0.0D, tangentZ));
        CollisionBody candidate = body.move(new Vec3d(
