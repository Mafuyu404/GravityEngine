 ...
 *
 * <p>Values are immutable GravityEngine {@link Vec3d}: no Minecraft vector is
 * retained, and no defensive copy of a caller-owned mutable vector is needed.</p>
 */
public final class ContactVelocityResolution {
    private final boolean feasible;
    private final boolean fallback;
    private final Vec3d velocity;
    private final Vec3d desiredVelocity;
    ...
    private ContactVelocityResolution(
        ...
        this.desiredVelocity = Objects.requireNonNull(
                desiredVelocity,
                "desiredVelocity"
        );
    ...
    public static ContactVelocityResolution unresolved(
            Vec3d desiredVelocity
    ) {
        return new ContactVelocityResolution(
                false,
    ...
    /** The exact velocity the projection was asked to realize. */
    public Vec3d desiredVelocity() {
