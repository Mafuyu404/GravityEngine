 ...
 * {@link GravityFieldRegistry}, never a platform level.</p>
 */
public final class GravityEvaluationService {
    ...
    public static GravityFieldEvaluation sampleFieldEvaluation(
        ...
        long registryRevision = registry.publicationRevision();
        GravitySample sample = sampleField(query, registry);

        return new GravityFieldEvaluation(
    ...
    public static GravityEvaluationSnapshot evaluateCharacterOperation(
        ...
        GravitySample evidence =
                characterEvidence(query, plan, registry);
    ...
    public static GravityEvaluationSnapshot evaluateForPlan(
        ...
        GravitySample evidence =
                fieldEvidence(query, plan, registry);
    ...
    private static GravitySample sampleField(
        ...
        return GravityFieldService.sample(
                registry,
                query.samplePoint(),
                query.velocity(),
                query.gameTick(),
