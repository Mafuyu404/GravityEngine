...
public final class CapsuleSphereCollision {
    ...
    private static void deterministicPerpendicular(Vec3d axis, ContactScratch scratch) {
        double seedX;
        double seedY;
        double seedZ;
    ...
    private static Vec3d deterministicPerpendicular(Vec3d axis) {
        Vec3d seed = Math.abs(axis.x()) <= Math.abs(axis.y())
    ...
    private static final class ContactScratch {
        ...
        private double directionalDerivative(Vec3d movement) {
        ...
        private ContactGeometry toImmutable() {
            return new ContactGeometry(
                    new Vec3d(segmentX, segmentY, segmentZ),
                    new Vec3d(obstacleX, obstacleY, obstacleZ),
