...
/**
 * Operation-local step-start control-support re-verification.
 *
 * <p>Re-verifies step-start control support on the current prepared body when
 * the previous completed movement published no usable support snapshot.</p>
 *
...
public final class StepStartSupportQuery {
     ...
     *
     * @param body                the operation's prepared body
     * @param frame               the operation's frozen reference frame
    ...
    public static Result query(
        ...
        if (continuityCandidate != null
            ...
            if (reacquired != null) {
                ...
                if (separatingFromSupport(frame, velocity, contact)) {
