...
public record BodyAttitudeDecision(
    ...
    /**
     * Held roll belongs to the geometric SemanticView controller path
     * (FREE_ATTITUDE). ELYTRA_ALIGNED deliberately consumes a zero controller
     * roll interval because its held roll is a physical torque contribution,
     * not this kinematic view roll.
     */
